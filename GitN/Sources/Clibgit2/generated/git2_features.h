/*
 * Pre-generated feature flags for macOS (arm64/x86_64).
 * Equivalent to cmake-generated git2_features.h with:
 *   -DUSE_SSH=OFF -DUSE_HTTPS=SecureTransport -DTHREADSAFE=ON
 */
